...
# api_key = (open('/home/abiola/Downloads/Football_Prediction_Project-master/api_key.txt', mode='r')).read()


def get_api_data(base_url, end_url):
    url = base_url + end_url
    headers = {'X-RapidAPI-Key': "d308809087msh1f9545bd48b9e30p106f34jsn79be1d18a3a0"}
...
def req_prem_fixtures_id(season_code, year=YEAR_str):
    ...
    save_api_output(f'{year}_premier_league_fixtures', premier_league_fixtures_sliced, json_data_path = '/home/abiola/Downloads/Football_Prediction_Project-master/prem_clean_fixtures_and_dataframes/')

    #loading the json file as a DataFrame
    premier_league_fixtures_df = read_json_as_pd_df(f'{year}_premier_league_fixtures.json', json_data_path='/home/abiola/Downloads/Football_Prediction_Project-master/prem_clean_fixtures_and_dataframes/')
...
fixtures = pd.read_json(f'/home/abiola/Downloads/Football_Prediction_Project-master/prem_clean_fixtures_and_dataframes/{YEAR_str}_premier_league_fixtures.json', orient='records')
...
fixtures_clean.to_csv(f'/home/abiola/Downloads/Football_Prediction_Project-master/prem_clean_fixtures_and_dataframes/{YEAR_str}_premier_league_fixtures_df.csv', index=False)
...
fixtures_clean_2019_2020_2021_2022 = pd.read_csv('/home/abiola/Downloads/Football_Prediction_Project-master/prem_clean_fixtures_and_dataframes/2019_2020_2021_2022_premier_league_fixtures_df.csv')

fixtures_clean_2023 = pd.read_csv('/home/abiola/Downloads/Football_Prediction_Project-master/prem_clean_fixtures_and_dataframes/2023_premier_league_fixtures_df.csv')
...
fixtures_clean_combined.to_csv('/home/abiola/Downloads/Football_Prediction_Project-master/prem_clean_fixtures_and_dataframes/2019_2020_2021_2022_2023_premier_league_fixtures_df.csv', index=False)



#-------------------------- REQUESTING SPECIFIC STATS -------------------------

fixtures_clean = pd.read_csv(f'/home/abiola/Downloads/Football_Prediction_Project-master/prem_clean_fixtures_and_dataframes/{YEAR_str}_premier_league_fixtures_df.csv')
...
existing_data_raw = listdir('/home/abiola/Downloads/Football_Prediction_Project-master/prem_game_stats_json_files/')
...
def req_prem_stats_list(missing_data):
    if len(missing_data) > 100:
        ...
        for i, dat in enumerate(missing_data):
            ...
            fixture_raw = get_api_data(base_url, '/statistics/fixture/' + fix_id + '/')
            fixture_sliced = slice_api(fixture_raw, 34, 2)
            save_api_output('/home/abiola/Downloads/Football_Prediction_Project-master/prem_game_stats_json_files/' + fix_id, fixture_sliced)
...
path_to_model = '/home/abiola/Downloads/Football_Prediction_Project-master/ml_model_build_random_forest/ml_models/random_forest_model_10.pk1'


#----------------------------- FEATURE ENGINEERING ----------------------------

with open(f'/home/abiola/Downloads/Football_Prediction_Project-master/prem_clean_fixtures_and_dataframes/{stats_dict_saved_name}', 'rb') as myFile:
...
fixtures_clean = pd.read_csv(f'/home/abiola/Downloads/Football_Prediction_Project-master/prem_clean_fixtures_and_dataframes/{fixtures_saved_name}')
...
with open(f'/home/abiola/Downloads/Football_Prediction_Project-master/prem_clean_fixtures_and_dataframes/{df_10_saved_name}', 'rb') as myFile:
...
with open('/home/abiola/Downloads/Football_Prediction_Project-master/predictions/pl_predictions.csv', 'wb') as myFile:
    pickle.dump(predictions, myFile)
with open('/home/abiola/Downloads/Football_Prediction_Project-master/web_server/pl_predictions.csv', 'wb') as myFile:
    pickle.dump(predictions, myFile)
...
for team in team_id_list:
    ...
    for j in team_fixture_list:
        #loading df
        df = pd.read_json('/home/abiola/Downloads/Football_Prediction_Project-master/prem_game_stats_json_files/' + str(j) + '.json', orient='values')
...
with open(f'/home/abiola/Downloads/Football_Prediction_Project-master/prem_clean_fixtures_and_dataframes/{stats_dict_output_name}', 'wb') as myFile:
...
with open(f'/home/abiola/Downloads/Football_Prediction_Project-master/prem_clean_fixtures_and_dataframes/{results_dict_saved_name}', 'wb') as myFile:
...
# token = (open('/home/abiola/Downloads/Football_Prediction_Project-master/api_key_python_anywhere.txt', mode='r')).read()
